...
describe("DisjointSetItem", () => {
  ...
  it("should do basic manipulation with disjoint set item with custom key extractor", () => {
    ...
    const itemB = new DisjointSetItem({ key: "B", value: 1 }, keyExtractor);
    const itemC = new DisjointSetItem({ key: "C", value: 1 }, keyExtractor);
    const itemD = new DisjointSetItem({ key: "D", value: 1 }, keyExtractor);
